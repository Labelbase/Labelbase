...
urlpatterns = [
    ...
    path('api/v0/labelbase/', LabelbaseAPIView.as_view(), name='api_labelbase'),
    path('api/v0/labelbase/<int:id>/', LabelbaseAPIView.as_view(), name='api_labelbase'),
    path('api/v0/labelbase/<int:labelbase_id>/label/', LabelAPIView.as_view(), name='api_label'),
    path('api/v0/labelbase/<int:labelbase_id>/label/<int:id>/', LabelAPIView.as_view(), name='api_label'),
