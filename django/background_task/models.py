...
class Task(models.Model):
    ...
    EVERY_3_WEEKS = 3 * WEEKLY
    EVERY_4_WEEKS = 4 * WEEKLY
    EVERY_5_WEEKS = 5 * WEEKLY
    EVERY_6_WEEKS = 6 * WEEKLY
    EVERY_7_WEEKS = 7 * WEEKLY
    EVERY_8_WEEKS = 8 * WEEKLY
    EVERY_9_WEEKS = 9 * WEEKLY
    EVERY_10_WEEKS = 10 * WEEKLY
    EVERY_12_WEEKS = 12 * WEEKLY
    EVERY_15_WEEKS = 15 * WEEKLY
    RANDOM_12_PLUS_WEEKS = -1
    NEVER = 0
    REPEAT_CHOICES = (
        (HOURLY, 'hourly'),
        (DAILY, 'daily'),
        ...
        (RANDOM_12_PLUS_WEEKS, 'every 12..24 weeks, random'),
        (NEVER, 'never'),
    )
    ...
    def is_repeating_task(self):
        return self.repeat > self.NEVER or self.repeat == self.RANDOM_12_PLUS_WEEKS
    ...
    def create_repetition(self):
        ...
        if self.repeat == self.RANDOM_12_PLUS_WEEKS:
            new_run_at = self.run_at + timedelta(seconds=random.randrange(self.EVERY_12_WEEKS, 2*self.EVERY_12_WEEKS))
        else:
